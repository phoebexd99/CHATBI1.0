...
const typeLabels: Record<string, string> = { all: "全部", metric: "认证指标", schema: "数据字段", term: "业务术语", verified_nl_sql: "参考问法" };
...
export default function KnowledgePage() {
  ...
  return <section className="page"><span className="eyebrow">Business knowledge</span><h1>每个数字，<br />都有清晰的解释。</h1><p className="lede">统一管理指标口径、数据字段、业务术语和参考问法，让每次回答都能说清楚“为什么这样算”。</p>
    ...
    <div className="knowledge-result-head"><strong>{filtered.length} 个匹配结果</strong><span>{replay ? "示例知识 · 静态演示" : "在线知识库"}</span></div>
